            ...
            <div className="max-w-6xl mx-auto pb-12 animate-slide-up px-4 sm:px-6">
                <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center gap-6">
                        <div className="w-16 h-16 bg-blue-600 rounded-[2rem] flex items-center justify-center text-white shadow-2xl shadow-blue-500/20">
                        ...
                        <div>
                            <h2 className="text-4xl font-black text-slate-900 tracking-tight">{office.name}</h2>
                            <p className="text-slate-500 font-medium text-lg">Sesuaikan titik koordinat dan radius geofencing secara visual.</p>
                        </div>
                    </div>
                    <Link 
