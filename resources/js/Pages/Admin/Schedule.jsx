    ...
    return (
        <AuthenticatedLayout header="Jadwal Semua Karyawan">
            ...
            <div className="space-y-6 animate-slide-up pb-12">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3">
                            ...
                            <div className="flex items-center gap-2">
                                <div className="relative">
                                    <select
                                        ...
                                        className="pl-9 pr-8 py-2.5 bg-white border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/20 transition-all cursor-pointer appearance-none min-w-[140px]"
                                ...
                                {/* FIX 1: tag <a> pembuka yang hilang */}
                                <a
                                    href={route('admin.export-presensi', { bulan: month, office_id: officeId || undefined })}
                        ...
                        <div className="flex items-center gap-1 bg-white rounded-2xl border border-slate-200 p-1.5 shadow-sm">
                            <button
                                ...
                                className={`px-5 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 flex items-center gap-2 ${activeTab === 'daily'
                            ...
                            <button
                                ...
                                className={`px-5 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 flex items-center gap-2 ${activeTab === 'monthly'
                                    ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg shadow-blue-500/25'
                                    : 'text-slate-500 hover:text-slate-700 hover:bg-slate-50'
                                    }`}
                            >
                    ...
                    <div className="p-6 border-b border-slate-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <select
                                ...
                                className="bg-slate-50 border border-slate-100 rounded-2xl px-4 py-2 text-sm font-bold text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all appearance-none pr-10 cursor-pointer"
                                style={{ backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%236b7280' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M6 8l4 4 4-4'/%3e%3c/svg%3e")`, backgroundPosition: 'right 0.5rem center', backgroundRepeat: 'no-repeat', backgroundSize: '1.5em 1.5em' }}
                            >
                ...
                {/* FIX 2: </div> penutup untuk <div className="space-y-6 animate-slide-up pb-12"> */}
            </div>
        </AuthenticatedLayout>
    );
}