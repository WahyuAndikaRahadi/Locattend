                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                                                ...
                                                <div className="px-4 py-2.5 bg-slate-50 rounded-2xl border border-slate-100 flex items-center gap-3">
                                                    ...
                                                    <div className="w-9 h-9 bg-white rounded-xl flex items-center justify-center text-blue-600 shadow-sm border border-slate-100 text-sm">
                                                        📅
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-center gap-2 mb-4">
                                                <span className="inline-flex items-center px-3 py-1 bg-blue-50 text-blue-600 rounded-lg text-xs font-bold">
                                            ...
                                            <div className="flex items-center gap-3">
                                                <button 
                                                    ...
                                                    className="flex-1 py-3.5 bg-emerald-600 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-lg shadow-emerald-600/20 hover:bg-emerald-500 hover:-translate-y-0.5 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                                                >
                                                ...
                                                <button 
                                                    ...
                                                    disabled={processing === leave.id}
                                                    className="flex-1 py-3.5 bg-white border border-rose-100 text-rose-500 rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-rose-500 hover:text-white hover:-translate-y-0.5 transition-all active:scale-95 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                                >
                                                    {processing === leave.id ? '⏳ Memproses...' : '❌ Tolak Pengajuan'}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="space-y-4">
                                {processedLeaves?.length > 0 ? processedLeaves.map((leave) => (
                                    ...
                                    <div className="py-10 text-center opacity-30">
                                        ...
                                        <p className="italic font-bold text-sm tracking-widest text-slate-500">Belum ada riwayat</p>
                                    </div>
                                )}
                            </div>
                        </div>
