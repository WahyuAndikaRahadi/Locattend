            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white p-8 sm:p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100">
                    <div className="text-center mb-8">
                        <h2 className="text-2xl font-bold text-dark-900">Pilih Kata Sandi Baru</h2>
                        <p className="text-dark-500 text-sm mt-2 leading-relaxed">
                            Buat kata sandi yang kuat untuk mengamankan akun Anda.
                        </p>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                name="email"
                                value={data.email}
                                className={`w-full px-5 py-4 bg-slate-50 border ${errors.email ? 'border-red-300' : 'border-slate-200'} rounded-2xl text-dark-900 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 transition-all font-medium opacity-70`}
                        ...
                        <div>
                            <label className="block text-xs font-bold text-dark-600 uppercase tracking-widest mb-2 ml-1" htmlFor="password_confirmation">
                            ...
                            <input
                                ...
                                className={`w-full px-5 py-4 bg-slate-50 border ${errors.password_confirmation ? 'border-red-300' : 'border-slate-200'} rounded-2xl text-dark-900 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 transition-all font-medium`}
                                placeholder="••••••••"
                                autoComplete="new-password"
                                required
                        ...
                        <div className="pt-2">
                            <button 
                                ...
                                disabled={processing}
                            >
                                {processing ? 'Memperbarui...' : 'Atur Ulang Kata Sandi'}
                            </button>
                        </div>
                    </form>
                </div>
